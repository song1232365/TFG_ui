...
class SSIMMeter:
    def __init__(self):
        ...
        try:
            ...
            raise ImportError(
                "SSIMMeter requires scikit-image. Install with: pip install scikit-image"
            ) from e
        self._ssim = _ssim
    ...
    def update(self, preds, truths):
        ...
        truths = truths.detach().cpu().numpy()[0]
        v = self._ssim(preds, truths, channel_axis=-1, data_range=1.0)
        self.V += v
        self.N += 1
...
class LPIPSMeter:
    def __init__(self, net='alex', device=None):
        ...
        try:
            ...
            raise ImportError(
                "LPIPSMeter requires lpips. Install with: pip install lpips"
            ) from e
