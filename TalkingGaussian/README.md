...
### (Optional) Prompt ASR Helper (for Voice Cloning)

If you use CosyVoice zero-shot voice cloning, you need `prompt_text` that matches the content of your prompt audio.
We provide a small offline ASR helper to generate a draft transcript for manual correction:
